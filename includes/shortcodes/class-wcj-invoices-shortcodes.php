...
public function init_atts( $atts ) {
    ...
    // Sanitize input attribute values
    $atts['order_id']     = wcj_sanitize_input_attribute_values( $atts['order_id'] );
    $atts['date_format']  = isset( $atts['date_format'] ) ? wcj_sanitize_input_attribute_values( $atts['date_format'], 'restrict_quotes' ) : '';
    $atts['days']         = isset( $atts['days'] ) ? wcj_sanitize_input_attribute_values( $atts['days'] ) : '';
    $atts['invoice_type'] = isset( $atts['invoice_type'] ) ? wcj_sanitize_input_attribute_values( $atts['invoice_type'] ) : '';
    $atts['doc_nr']       = isset( $atts['doc_nr'] ) ? wcj_sanitize_input_attribute_values( $atts['doc_nr'] ) : '';
    $atts['srcs']         = isset( $atts['srcs'] ) ? wcj_sanitize_input_attribute_values( $atts['srcs'], 'src' ) : '';
