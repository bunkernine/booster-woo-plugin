...
$settings = array(
	...
	array(
		...
		'desc_tip'          => __( 'If the VAT number missing a country code, this feature will automatically assign the country code based on the billing country.', 'woocommerce-jetpack' ) . '<br>' .
			apply_filters( 'booster_message', '', 'desc' ),
